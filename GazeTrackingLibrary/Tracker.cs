...
namespace GazeTrackingLibrary
{
    public class Tracker
    {
        ...
        // Send the calibration point of the entire list to the client
        public void CalibrationPointList(int n, Point point)
        {
            server.SendMessage(GazeTrackerClient.Commands.CalibrationPointChange,"Point:" + n + " x:" + point.X + " y:" + point.Y + " ");
        }
