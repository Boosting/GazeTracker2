...
namespace GTHardware.Cameras.Thorlabs
{
    ...
    public class ThorlabSettings : INotifyPropertyChanged
    {
        ...
        private int globalShutter = 0;

        // Gain
        private int gainMaster = 0;
        ...
        // Auto features
        private bool brightnessExposureControl = false; // 0
        private bool brightnessGainControl = false; // 0
        ...
        public double Exposure
        {
            ...
            set
            {
                double actualEXP = 0;
                exposure = value;
                if (camera.SetExposureTime(exposure, ref actualEXP) != ThorlabDevice.IS_SUCCESS)
                    Console.Out.WriteLine("UC480, set Exp: " + exposure + " Got: " + actualEXP);
        ...
        public void ReadAndApplyNativeIni(string filepath)
        {
            ...
            */
            ...
            int briExpControl = Convert.ToInt32(ini.IniReadValue("Auto features", "Brightness exposure control"));
            if (briExpControl == 0)
                AutoBrightnessExposureSensorControl = false;
            else
                AutoBrightnessExposureSensorControl = true;
